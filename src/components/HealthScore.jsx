...
export default function HealthScore({ score }) {
  ...
  const getColor = (s) => {
    ...
    if (s > 50) return "var(--warning, #FFB800)";
  ...
  return (
    <div ref={container} className="flex flex-col items-center justify-center p-8 bg-card border border-border rounded-xl mb-8 shadow-sm">
      <div className="relative flex items-center justify-center w-40 h-40">
        ...
        <div className="absolute flex flex-col items-center justify-center">
          <span className="text-4xl font-extrabold font-mono text-primary health-score-number">0</span>
