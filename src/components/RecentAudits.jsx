      ...
      <div className="grid gap-3">
        {history.map((audit) => (
          <div 
            ...
            className="bg-card border border-border p-4 rounded flex items-center justify-between cursor-pointer hover:border-accent/50 transition-colors"
          >
            <div>
            ...
            <div className="flex items-center gap-4">
              <div className={`text-xl font-bold ${
                audit.score > 75 ? "text-accent" : audit.score > 50 ? "text-warning" : "text-destructive"
              }`}>
                {audit.score}
              </div>
